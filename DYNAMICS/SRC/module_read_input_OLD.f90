...
subroutine read_input(eflag,sfile,tfile,fframe,stride,lframe,hw_ex,ns,ws,n_ws,zmin,zmax,dz, &
                      it0,dt,kvec,ttau,switch_diff,switch_sisf,switch_chi4,linear)

implicit none
                   
integer :: stride, lframe, eflag, ns, fframe, i, it0
real :: zmin, zmax, dz, dt, kvec, ttau, linear
character*3 :: hw_ex, switch_diff, switch_sisf, switch_chi4
