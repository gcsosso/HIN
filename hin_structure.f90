...
integer, allocatable :: n_ws(:), n_r_ws(:), list_ws(:,:), list_r_ws(:,:), r_nper(:), mflag(:), resnum(:), idx_cls(:),icy(:),coloring(:),current_color(:),current_coord(:,:)
...
>>>>>>> dc0098408ba120d5f0cec10a24ec5e65a49bb306
